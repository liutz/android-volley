...
public class TestStringNotRevalidateTranscation extends BaseStringTransaction {	
	private static final String TAG = "TestStringNotRevalidateTranscation";

	public TestStringNotRevalidateTranscation( HttpCallback callback) {
		super(callback);
	}	

	@Override
	public String getDevelopUrl() {
		return Configs.API_SERVER_DEVP+Configs.URL.STRING_NOT_REVALIDATE_URL;
	}

	@Override
	public String getBasicUrl() {
		return Configs.API_SERVER_PRODUCT+Configs.URL.STRING_NOT_REVALIDATE_URL;
	}
	...
	public String getTag() {
		return "TestStringNotRevalidateTranscation";
	}
}
