...
public class TestJsonNotRevalidateTranscation extends BaseJsonTransaction {
	
	public TestJsonNotRevalidateTranscation(HttpCallback callback) {
		super(callback);	
	}
	...
	public String getDevelopUrl() {		
		return Configs.API_SERVER_DEVP + Configs.URL.JSON_NOT_REVALIDATE_URL;
	}

	@Override
	public String getBasicUrl() {		
		return Configs.API_SERVER_PRODUCT + Configs.URL.JSON_NOT_REVALIDATE_URL;
	}
	...
	public String getTag() {
		return "TestJsonNotRevalidateTranscation";
	}
}